...
//    private static let allUsersKey = "allUsers"
//    private static let currentUserKey = "currentUser"
//
//    // Save all users
//    func saveAllUsers(_ users: [String: User]) {
//        if let encoded = try? JSONEncoder().encode(users) {
//            set(encoded, forKey: UserDefaults.allUsersKey)
//        }
//    }
//
//    // Retrieve all users
//    func getAllUsers() -> [String: User] {
//        if let data = data(forKey: UserDefaults.allUsersKey),
...
//    func saveCurrentUser(_ email: String) {
//        set(email, forKey: UserDefaults.currentUserKey)
//    }
//
//    // Retrieve the current logged-in user
//    func getCurrentUser() -> String? {
//        return string(forKey: UserDefaults.currentUserKey)
//    }
//
//    // Log out the current user
//    func logoutCurrentUser() {
//        removeObject(forKey: UserDefaults.currentUserKey)
//    }
//}
