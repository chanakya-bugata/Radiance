...
class CompleteViewController: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == tableviewCR {
            ...
            cell.checkboxCR.tag = indexPath.row
            cell.checkboxCR.addTarget(self, action: #selector(toggleCheckboxCR(sender:)), for: .touchUpInside)
            ...
            cell.checkboxCR2.tag = indexPath.row
            cell.checkboxCR2.addTarget(self, action: #selector(toggleCheckboxCR2(sender:)), for: .touchUpInside)
