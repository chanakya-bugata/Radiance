...
class completeRoutine1TableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var checkboxCR: UIButton!
    override func awakeFromNib() {
        ...
        func configureCell(with log: CompleteLogCR) {
            ...
            let checkboxImage = log.checklistCheckedCR ? UIImage(named: "checked_checkbox") : UIImage(named: "unchecked_checkbox")
            checkboxCR.setImage(checkboxImage, for: .normal)
        }
    }
