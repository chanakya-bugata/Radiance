...
var allProducts = [
    ...
    Product(name: "Deconstruct Serum", type: "Serum", cost: "INR 25", rating: 4.8, imageName: "serum 1"),
    Product(name: "Cetaphil Moisturizing Cream", type: "Cream", cost: "INR 20", rating: 4.2, imageName: "moisturizer")
]
