...
class completeRoutine2TableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var checkboxCR2: UIButton!
    ...
    func configure(with log: CompleteLogCR2) {
            ...
            let checkboxImage = log.checklistCheckedCR2 ? UIImage(named: "checkmark") : UIImage(named: "unchecked")
            checkboxCR2.setImage(checkboxImage, for: .normal)
        }
    }
